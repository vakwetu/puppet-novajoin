...
describe 'novajoin::keystone::authtoken' do
  ...
  shared_examples 'novajoin authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_novajoin_config('keystone_authtoken/password').with_value('secrete')
        is_expected.to contain_novajoin_config('keystone_authtoken/auth_url').with_value('http://localhost:35357')
        ...
        is_expected.to contain_novajoin_config('keystone_authtoken/auth_uri').with_value('http://localhost:5000')
        ...
        is_expected.to contain_novajoin_config('keystone_authtoken/signing_dir').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_novajoin_config('keystone_authtoken/signing_dir').with_value(params[:signing_dir])
